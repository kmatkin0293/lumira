...
const PASSTHROUGH_MAP = {
    ...
    [types_1.HostEvent.Pin]: contracts_1.UIPassthroughEvent.PinAnswerToLiveboard,
    [types_1.HostEvent.SaveAnswer]: contracts_1.UIPassthroughEvent.SaveAnswer,
    [types_1.HostEvent.UpdateFilters]: contracts_1.UIPassthroughEvent.UpdateFilters,
    [types_1.HostEvent.DrillDown]: contracts_1.UIPassthroughEvent.Drilldown,
    // Getters (use getDataWithPassthroughFallback)
    [types_1.HostEvent.GetAnswerSession]: contracts_1.UIPassthroughEvent.GetAnswerSession,
    [types_1.HostEvent.GetFilters]: contracts_1.UIPassthroughEvent.GetFilters,
    [types_1.HostEvent.GetIframeUrl]: contracts_1.UIPassthroughEvent.GetIframeUrl,
    [types_1.HostEvent.GetParameters]: contracts_1.UIPassthroughEvent.GetParameters,
    [types_1.HostEvent.GetTML]: contracts_1.UIPassthroughEvent.GetTML,
    [types_1.HostEvent.GetTabs]: contracts_1.UIPassthroughEvent.GetTabs,
    [types_1.HostEvent.getExportRequestForCurrentPinboard]: contracts_1.UIPassthroughEvent.GetExportRequestForCurrentPinboard,
};
class HostEventClient {
    ...
    async getAvailableUIPassthroughKeys(context) {
        ...
        try {
            const response = await this.triggerUIPassthroughApi(contracts_1.UIPassthroughEvent.GetAvailableUIPassthroughs, {}, context);
    ...
    handleUpdateFiltersEvent(payload, context) {
        ...
        return this.handleHostEventWithParam(contracts_1.UIPassthroughEvent.UpdateFilters, payload, context);
    }
    handleDrillDownEvent(payload, context) {
        if (!(0, utils_1.isValidDrillDownPayload)(payload)) {
            (0, utils_1.throwDrillDownValidationError)();
        }
        return this.handleHostEventWithParam(contracts_1.UIPassthroughEvent.Drilldown, payload, context);
    }
    /**
